  ...
  <div className="max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
    ...
    <div className="mt-8 grid grid-cols-1 gap-8 md:mt-16 md:grid-cols-2 md:gap-12 lg:grid-cols-3">
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-lg font-bold">Flexible timings.</h2>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-lg font-bold">Special doctors for every desease.</h2>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-lg font-bold">Complete treatment and courses.</h2>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-lg font-bold">Money back gurentee.</h2>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-lg font-bold">Best doctors from around the world.</h2>
      ...
      <div className="flex items-start gap-4">
        ...
        <div>
          <h2 className="text-lg font-bold">Best in class facilities.</h2>
